...
<?php
if ($nav) { ?>
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="background-color: #333 !important;">
    ...
    if ($cfg && $cfg->isKnowledgebaseEnabled()) { ?>
        <div class="search-area-wrapper">
            <div class="search-area container">
                <h3 class="col-sm-12 search-header">Selamat Datang di Pusat Bantuan</h3>
                <p class="col-sm-12 search-tag-line">Jika Anda memiliki pertanyaan, Anda dapat bertanya di bawah ini atau memasukkan apa yang Anda 
				cari</p>
                ...
                <form id="search-form" class="search-form clearfix" method="get" action="/kb/faq.php" autocomplete="off"
                    ...
                    <input class="search-term required" type="text" id="s" name="q"
                           placeholder="Cari di Pengetahuan dasar kami" title="* Please enter a search term!"
                           autocomplete="off">
