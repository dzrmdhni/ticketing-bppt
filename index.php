        ...
        <div class="col-sm-12">
            <div class="card new-ticket text-center">
                <div class="card-body row">
                    <div class="col-sm-10">
                        <h4 class="featured-header">Masih memiliki pertanyaan? Kami bisa membantu!</h4>
                        <p class="featured-tag-line">Hubungi kami dan kami akan membalas anda segera.</p>
                    </div>
                    <div class="col-sm-2">
    ...
    <div class="featured-block">
        ...
        if ($cfg && $cfg->isKnowledgebaseEnabled()) {
          ...
          ?>
            ...
            if ($cats->all()) { ?>
            <h3 class="featured-header"><?php echo __('Artikel Pengetahuan Dasar terfitur'); ?></h3>
                <?php
            }
            ?>
        <br/><br/>
